...
SEGMENT_CACHE_SIZE = _pysc.SEGMENT_CACHE_SIZE
MAX_PATH_LENGTH = _pysc.MAX_PATH_LENGTH
SC_INTERNAL_THREADS_SUPPORT = _pysc.SC_INTERNAL_THREADS_SUPPORT
...
class _sc_stat(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, _sc_stat, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, _sc_stat, name)
    __repr__ = _swig_repr
    __swig_setmethods__["node_count"] = _pysc._sc_stat_node_count_set
    __swig_getmethods__["node_count"] = _pysc._sc_stat_node_count_get
    if _newclass:node_count = _swig_property(_pysc._sc_stat_node_count_get, _pysc._sc_stat_node_count_set)
    __swig_setmethods__["arc_count"] = _pysc._sc_stat_arc_count_set
    __swig_getmethods__["arc_count"] = _pysc._sc_stat_arc_count_get
    if _newclass:arc_count = _swig_property(_pysc._sc_stat_arc_count_get, _pysc._sc_stat_arc_count_set)
    __swig_setmethods__["link_count"] = _pysc._sc_stat_link_count_set
    __swig_getmethods__["link_count"] = _pysc._sc_stat_link_count_get
    if _newclass:link_count = _swig_property(_pysc._sc_stat_link_count_get, _pysc._sc_stat_link_count_set)
    __swig_setmethods__["node_live_count"] = _pysc._sc_stat_node_live_count_set
    __swig_getmethods__["node_live_count"] = _pysc._sc_stat_node_live_count_get
    if _newclass:node_live_count = _swig_property(_pysc._sc_stat_node_live_count_get, _pysc._sc_stat_node_live_count_set)
    __swig_setmethods__["arc_live_count"] = _pysc._sc_stat_arc_live_count_set
    __swig_getmethods__["arc_live_count"] = _pysc._sc_stat_arc_live_count_get
    if _newclass:arc_live_count = _swig_property(_pysc._sc_stat_arc_live_count_get, _pysc._sc_stat_arc_live_count_set)
    __swig_setmethods__["link_live_count"] = _pysc._sc_stat_link_live_count_set
    __swig_getmethods__["link_live_count"] = _pysc._sc_stat_link_live_count_get
    if _newclass:link_live_count = _swig_property(_pysc._sc_stat_link_live_count_get, _pysc._sc_stat_link_live_count_set)
    __swig_setmethods__["empty_count"] = _pysc._sc_stat_empty_count_set
    __swig_getmethods__["empty_count"] = _pysc._sc_stat_empty_count_get
    if _newclass:empty_count = _swig_property(_pysc._sc_stat_empty_count_get, _pysc._sc_stat_empty_count_set)
    def __init__(self): 
        this = _pysc.new__sc_stat()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _pysc.delete__sc_stat
    __del__ = lambda self : None;
_sc_stat_swigregister = _pysc._sc_stat_swigregister
_sc_stat_swigregister(_sc_stat)
