macro(sc_codegen_ex Target SrcPath OutputPath)
    ...
    if(MSVC)
        ...
        set(META_FLAGS ${META_FLAGS} "-IC:/Program Files (x86)/Microsoft Visual Studio ${VS_VERSION}/VC/include")
    elseif(${UNIX})
        set(META_FLAGS ${META_FLAGS} "-I${LIBCLANG_LIBDIR}/clang/${LIBCLANG_VERSION_STRING}/include/")
    else()
