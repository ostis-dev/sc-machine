...
#define SC_TASK_QUEUE_CREATE(queue, size)   queue = (sc_static_async_queue*) sc_sa_queue_new(size);
#define SC_TASK_QUEUE_FREE(queue, func)     sc_sa_queue_destroy(queue, func);
#define SC_TASK_QUEUE_POP_TASK(queue, task) sc_task* task = (sc_task*) sc_sa_queue_pop(queue);
#define SC_TASK_QUEUE_ADD_TASK(queue, task) sc_sa_queue_push(queue, task);
