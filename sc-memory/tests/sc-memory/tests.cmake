make_tests_from_folder(
    ...
    NAME
    sc-memory-common-tests
    DEPENDS
    sc-memory
    INCLUDES
    ${SC_MEMORY_SRC}
    ${CMAKE_CURRENT_LIST_DIR}/_test)

sc_codegen(sc-memory-common-tests ${CMAKE_CURRENT_LIST_DIR}/common)

make_tests_from_folder(
    ${CMAKE_CURRENT_LIST_DIR}/agents
    NAME
    sc-memory-agents-tests
    DEPENDS
    sc-memory
    INCLUDES
    ${SC_MEMORY_SRC}
